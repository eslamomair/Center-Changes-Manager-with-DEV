...
namespace CenterChangesManager.BLL
{
    public class clsInspector
    {
        ...
        private clsInspector(int id, string name, int cityid, string phone)
        {
            this.InspectorID = id;
        ...
        public static clsInspector Find(int id)
        {
            string name = "", phone = "";
            int cityid = -1;
            if (clsInspectorData.GetInspectorInfoByID(id, ref name, ref cityid, ref phone))
                return new clsInspector(id, name, cityid, phone);
            else return null;
        }
        ...
        {
            this.InspectorID = clsInspectorData.AddNew(this.InspectorName, this.City_ID, this.Phone);
            return (this.InspectorID != -1);
        }

        private bool _Update()
        {
            return clsInspectorData.Update(this.InspectorID, this.InspectorName, this.City_ID, this.Phone);
        }
